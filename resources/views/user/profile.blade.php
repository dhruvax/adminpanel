...
<div class="content-header">
            ...
            @csrf
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card"> <img class="card-img" src="{{url('assets/img/laravel1.jpeg')}}" height="450" alt="Card image">
                            <div class="card-img-overlay card-inverse text-white social-profile d-flex no-block">
                                <div class="align-self-center"> 
                                    <img src="{{url('assets/img')}}/{{$user->image}}" class="img-circle d-block" width="100" height="100">
                                    
                                <h4 class="card-title text-white">{{$user->full_name}}</h4></br><br>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="{{url('#profile')}}" role="tab" aria-selected="true">Profile</a> </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile" role="tabpanel">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <p class="m-t-30">{{$user->description}}</p>   
                                        <div class="col text-right">
                <a href="{{url('editdata')}}/{{$user->id}}" class="btn btn-secondary content-link btn-sm">update profile</a>
